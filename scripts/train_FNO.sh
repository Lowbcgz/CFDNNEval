...
# TGV
CUDA_VISIBLE_DEVICES=0 python train.py ./config/FNO/config_TGV_all.yaml -c Re_ReD | tee ./log/train/FNO_tgv_Re_ReD.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/FNO/config_TGV_all.yaml -c Re | tee ./log/train/FNO_tgv_Re.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/FNO/config_TGV_all.yaml -c ReD | tee ./log/train/FNO_tgv_ReD.out
