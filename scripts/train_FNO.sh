...
# Darcy
# CUDA_VISIBLE_DEVICES=5 python train.py ./config/FNO/config_Darcy_ar_as.yaml -c ar | tee ./log/train/FNO_darcy_ar.out
# CUDA_VISIBLE_DEVICES=5 python train.py ./config/FNO/config_Darcy_ar_as.yaml -c as | tee ./log/train/FNO_darcy_as.out