...
# TGV
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNO/config_TGV_all.yaml -c all --test | tee ./log/test/UNO_tgv_all.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNO/config_TGV_all.yaml -c single --test | tee ./log/test/UNO_tgv_single.out
