...
# TGV
# CUDA_VISIBLE_DEVICES=0 python train.py ./config/FNO/config_TGV_ALL.yaml -c rho_V0_nu --test | tee ./log/test/FNO_tgv_rho_V0_nu.out
# CUDA_VISIBLE_DEVICES=0 python train.py ./config/FNO/config_TGV_ALL.yaml -c rho --test | tee ./log/test/FNO_tgv_rho.out
# CUDA_VISIBLE_DEVICES=0 python train.py ./config/FNO/config_TGV_ALL.yaml -c V0 --test | tee ./log/test/FNO_tgv_V0.out
# CUDA_VISIBLE_DEVICES=0 python train.py ./config/FNO/config_TGV_ALL.yaml -c nu --test | tee ./log/test/FNO_tgv_nu.out
