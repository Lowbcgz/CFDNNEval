...
# # TGV
CUDA_VISIBLE_DEVICES=0 python train.py ./config/OFormer/config_TGV_all.yaml -c Re_ReD --test | tee ./log/OFormer/test/OFormer_tgv_Re_ReD.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/OFormer/config_TGV_all.yaml -c Re --test | tee ./log/OFormer/test/OFormer_tgv_Re.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/OFormer/config_TGV_all.yaml -c ReD --test | tee ./log/OFormer/test/OFormer_tgv_ReD.out
...
# # Darcy
CUDA_VISIBLE_DEVICES=0 python train.py ./config/OFormer/config_Darcy_PDEBench.yaml -c PDEBench --test | tee ./log/OFormer/test/OFormer_darcy_PDEBench.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/OFormer/config_Darcy_darcy.yaml -c darcy --test | tee ./log/OFormer/test/OFormer_darcy_darcy.out
