...
# TGV
CUDA_VISIBLE_DEVICES=7 python train.py ./config/UNO/config_TGV_all.yaml -c all | tee ./log/train/UNO_tgv_all.out
CUDA_VISIBLE_DEVICES=7 python train.py ./config/UNO/config_TGV_all.yaml -c single | tee ./log/train/UNO_tgv_single.out
