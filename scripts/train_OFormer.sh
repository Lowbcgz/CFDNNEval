...
# # TGV
CUDA_VISIBLE_DEVICES=0 python train.py ./config/OFormer/config_TGV_all.yaml -c Re_ReD | tee ./log/OFormer/train/OFormer_tgv_Re_ReD.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/OFormer/config_TGV_all.yaml -c Re | tee ./log/OFormer/train/OFormer_tgv_Re.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/OFormer/config_TGV_all.yaml -c ReD | tee ./log/OFormer/train/OFormer_tgv_ReD.out
...
# # Darcy
CUDA_VISIBLE_DEVICES=0 python train.py ./config/OFormer/config_Darcy_PDEBench.yaml -c PDEBench | tee ./log/OFormer/train/OFormer_darcy_PDEBench.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/OFormer/config_Darcy_darcy.yaml -c darcy | tee ./log/OFormer/train/OFormer_darcy_darcy.out
