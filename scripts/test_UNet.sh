...
# TGV
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNet/config_TGV_all.yaml -c all --test | tee ./log/UNet/test/UNet_tgv_all.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNet/config_TGV_all.yaml -c single --test | tee ./log/UNet/test/UNet_tgv_single.out
...
# NSCH
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNet/config_NSCH_ALL.yaml -c bc --test | tee ./log/UNet/test/UNet_nsch_bc.out
...
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNet/config_NSCH_ALL.yaml -c pre --test | tee ./log/UNet/test/UNet_nsch_pre.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNet/config_NSCH_ALL.yaml -c re --test | tee ./log/UNet/test/UNet_nsch_re.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNet/config_NSCH_ALL.yaml -c uv0 --test | tee ./log/UNet/test/UNet_nsch_uv0.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNet/config_NSCH_ALL.yaml -c bc_ca_mob_phi_pre_re_uv0 --test | tee ./log/UNet/test/UNet_nsch_bc_ca_mob_phi_pre_re_uv0.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNet/config_NSCH_ALL.yaml -c ca_mob_re --test | tee ./log/UNet/test/UNet_nsch_ca_mob_re.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNet/config_NSCH_ALL.yaml -c phi_pre_uv0 --test | tee ./log/UNet/test/UNet_nsch_phi_pre_uv0.out

# Darcy
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNet/config_Darcy_ar_as.yaml -c ar --test | tee ./log/UNet/test/UNet_darcy_ar.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNet/config_Darcy_ar_as.yaml -c as --test | tee ./log/UNet/test/UNet_darcy_as.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/UNet/config_Darcy_ar_as.yaml -c as_ar --test | tee ./log/UNet/test/UNet_darcy_as_ar.out
CUDA_VISIBLE_DEVICES=6 python train.py ./config/UNet/config_Darcy_PDEBench.yaml -c PDEBench --test | tee ./log/UNet/test/UNO_PDEBench.out
