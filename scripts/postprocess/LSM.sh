...
### transfering
# tube
CUDA_VISIBLE_DEVICES=0 python transfering_test.py ./config/LSM/config_tube_prop_bc_geo.yaml -cs bc_geo -ct bc,geo,prop
CUDA_VISIBLE_DEVICES=0 python transfering_test.py ./config/LSM/config_tube_prop_bc_geo.yaml -cs prop_geo -ct bc,geo,prop
CUDA_VISIBLE_DEVICES=0 python transfering_test.py ./config/LSM/config_tube_prop_bc_geo.yaml -cs prop_bc -ct bc,geo,prop
...
CUDA_VISIBLE_DEVICES=0 python transfering_test.py ./config/LSM/config_NSCH_ALL.yaml -cs ca_mob_re_eps -ct ibc,phi,ca,mob,re,eps
CUDA_VISIBLE_DEVICES=0 python transfering_test.py ./config/LSM/config_NSCH_ALL.yaml -cs phi_ibc -ct ibc,phi,ca,mob,re,eps
