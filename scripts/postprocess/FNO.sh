...
# NSCH
CUDA_VISIBLE_DEVICES=0 python collect_nmse.py ./config/FNO/config_NSCH_ALL.yaml -c ca

# TGV
CUDA_VISIBLE_DEVICES=0 python collect_nmse.py ./config/FNO/config_TGV_all.yaml -c all
