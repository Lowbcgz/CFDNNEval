...
# TGV
CUDA_VISIBLE_DEVICES=0 python train.py ./config/KNO/config_TGV_all.yaml -c all --test | tee ./log/KNO/test/KNO_tgv_all.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/KNO/config_TGV_all.yaml -c single --test | tee ./log/KNO/test/KNO_tgv_single.out
...
# NSCH
CUDA_VISIBLE_DEVICES=0 python train.py ./config/KNO/config_NSCH_ALL.yaml -c bc --test | tee ./log/KNO/test/KNO_nsch_bc.out
...
CUDA_VISIBLE_DEVICES=0 python train.py ./config/KNO/config_NSCH_ALL.yaml -c pre --test | tee ./log/KNO/test/KNO_nsch_pre.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/KNO/config_NSCH_ALL.yaml -c re --test | tee ./log/KNO/test/KNO_nsch_re.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/KNO/config_NSCH_ALL.yaml -c uv0 --test | tee ./log/KNO/test/KNO_nsch_uv0.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/KNO/config_NSCH_ALL.yaml -c bc_ca_mob_phi_pre_re_uv0 --test | tee ./log/KNO/test/KNO_nsch_bc_ca_mob_phi_pre_re_uv0.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/KNO/config_NSCH_ALL.yaml -c ca_mob_re --test | tee ./log/KNO/test/KNO_nsch_ca_mob_re.out
CUDA_VISIBLE_DEVICES=0 python train.py ./config/KNO/config_NSCH_ALL.yaml -c phi_pre_uv0 --test | tee ./log/KNO/test/KNO_nsch_phi_pre_uv0.out
