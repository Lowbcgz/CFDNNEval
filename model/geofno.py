...
class geoFNO2d(nn.Module):
    def __init__(self, modes1, modes2, width, inputs_channel, outputs_channel=None, is_mesh=True, s1=96, s2=96, use_iphi=True, n_case_params=5, initial_step=1):
        ...
        """
        in_channels = inputs_channel*initial_step+1+2+n_case_params
